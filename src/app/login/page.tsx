    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-slate-100 relative">
        ...
        <h1 className="text-2xl font-black text-slate-900 mb-2 text-center">
          Willkommen bei Sherpass
        </h1>
        <p className="text-slate-500 text-center mb-8 text-sm">
          Logg dich ein oder erstelle einen Account.
        </p>
        ...
        <form className="space-y-4">
          <div>
            ...
            <div className="relative mt-1">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3 pl-10 focus:ring-2 focus:ring-orange-500 outline-none transition text-slate-900"
              />
            </div>
          </div>
          <div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-4">
            ...
            <button
              formAction={signup}
              className="w-full bg-white border-2 border-slate-200 text-slate-900 font-bold py-3 rounded-xl hover:border-orange-500 hover:text-orange-500 transition"
            >
              Registrieren
            </button>
          </div>
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          Min. 6 Zeichen für das Passwort.
        </p>
      </div>
    </div>
  );
